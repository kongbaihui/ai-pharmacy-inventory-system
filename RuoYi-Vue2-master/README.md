...
<h4 align="center">基于SpringBoot+Vue2前后端分离的Java快速开发框架</h4>
<p align="center">
...
* 本仓库为前端技术栈 [Vue2](https://v2.cn.vuejs.org) + [Element UI](https://element.eleme.cn/#/zh-CN) + [Vue CLI](https://v3.cli.vuejs.org/zh) 版本。
...
```bash
# 克隆项目
git clone https://github.com/yangzongzhuan/RuoYi-Vue2.git
